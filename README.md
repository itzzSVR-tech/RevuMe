...
<div>
        <img alt="Static Badge" src="https://img.shields.io/badge/React_Router_v7-CA4245?style=for-the-badge&logo=react-router&logoColor=white">
...
```bash
git clone https://github.com/itzzSVR-tech/RevuMe.git
cd RevuMe
```
